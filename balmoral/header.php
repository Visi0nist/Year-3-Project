...
$modalCssPathFile = $auxiliaryLinkRelPath."styles/cookieconsentmodal.css";
...
if ($prepareCustomButtonBar == 1)
    {
        ...
        $navbarRHS = "
                ...
                <input type  = 'hidden'                                   name   = 'fOriginator'      value = 'headerSearch16533'>
                <input class = 'paleBackground'  type   = 'text'          name   = 'fSearchCriteria'  value = ''           size='35'>
                <input class = 'navbarButton'    type   = 'submit'                                    value = ' Search 16533 '>
                </form>
