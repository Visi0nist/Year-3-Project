...
$graphCanvasWidth    = 600;
$graphCanvasHeight   = 400;

// heightAsPercentage is expressed as an integer, 40% is simply 40, this is the viewable price range on our graph, 
// so 40% allows us to see 20% above and 20% below (a rebased price to 100)

$heightAsPercentage  = 30; 
